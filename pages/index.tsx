...
export default function Home() {
  ...
  return (
    <main
      className={`relative flex size-full flex-col items-center justify-between bg-white px-16 py-32 sm:items-start dark:bg-black ${geistSans.className} ${geistMono.className}`}
    >
      <Image
