    ...
    <>
      ...
      >
        ...
        {mounted && createPortal(
          <div
            ref={viewerRef}
            className="fixed inset-0 z-9999 pointer-events-none flex items-center justify-center transform-gpu"
            style={{
              padding: 'var(--viewer-pad)',
              '--enlarge-radius': openedImageBorderRadius,
              '--viewer-pad': rootRef.current?.style.getPropertyValue('--viewer-pad') || '72px'
            } as React.CSSProperties}
          >
            <div
              ref={scrimRef}
            ...
            <div
              ref={frameRef}
              className="viewer-frame relative h-full max-w-full aspect-square flex pointer-events-none"
              style={{
